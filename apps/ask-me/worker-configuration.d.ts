/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 383b1e44165ed0f55aa023f1ed0dc8d5)
// Runtime types generated with workerd@1.20250604.0 2025-05-25 nodejs_compat
declare namespace Cloudflare {
  interface Env {
    OPENAI_API_KEY: string;
    OPENAI_BASE_URL: string;
    INTERNAL_OPENAI_BASE_URL: string;
    MCP_OBJECT: DurableObjectNamespace<import("./src/index").AskMCP>;
    ASK_ME_AGENT: DurableObjectNamespace<import("./src/index").AskMeAgent>;
    BUCKET: R2Bucket;
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        "OPENAI_API_KEY" | "OPENAI_BASE_URL" | "INTERNAL_OPENAI_BASE_URL"
      >
    > {}
}
